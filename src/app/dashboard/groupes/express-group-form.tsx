...
export function ExpressGroupForm({
  ...
  const [name, setName] = useState(defaultExpressGroupName());
  ...
  return (
    <form action={createExpressGroup} className="flex flex-col gap-5 rounded-2xl border border-[color-mix(in_srgb,var(--color-border)_68%,var(--color-foreground))] bg-[var(--color-surface)] p-5 shadow-[var(--elev-2)]">
