  ...
  return (
    <div className="flex flex-col gap-2.5">
      <button
        ...
        className="group relative mx-auto overflow-hidden rounded-xl border border-black/[0.07] bg-white p-3.5 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_8px_20px_-8px_rgba(0,0,0,0.14)] transition-[transform,box-shadow] duration-[180ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-[0_1px_2px_rgba(0,0,0,0.05),0_14px_28px_-10px_rgba(0,0,0,0.18)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-brand)] active:translate-y-0 active:scale-100 dark:border-white/[0.1]"
      ...
      >
        ...
        <img
          ...
          className="h-[9.5rem] w-[9.5rem] transition-transform duration-[180ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-[1.015]"
        />
        <span
